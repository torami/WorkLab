...
public class TcellDAOToken extends Tools{
	 ...
	 * @throws Exception
	 */
	public void InsertVisite(int GID,int IdPRATICIEN,Date DateVI,String Poid ,String Taille,String IMC,String Glyc,String TA,String Insuline) {
		...
		try {
			...
			String query= "INSERT INTO VISITE  VALUES ("+ GID+","+IdPRATICIEN+","+DateVI+","+Poid+",,"+Taille+","+IMC+","+Glyc+","+TA+",,"+Insuline+")";
			//System.out.println("Executing query : " + query);			
	 ...
	 * @throws Exception
	 */
	public void InsertPraticien(int GID,String nom ,String prenom,String password,String grade,String service) {
		...
		try {
			...
			String query= "INSERT INTO PRATICIEN  VALUES ("+ GID+","+nom+","+prenom+","+password+",,"+grade+","+service+")";
			//System.out.println("Executing query : " + query);			
	 ...
	 * @throws Exception
	 */
	public void insertAntecedentsMed(int GID,Date DateFirstCon,Date  DateInsuline,String ConsoAlc ,String ConsoTab, String AccidentVS) {
		...
		try {
			...
			String query= "INSERT INTO Antécedent_Med  VALUES ("+ GID+","+DateFirstCon+","+DateInsuline+","+ConsoAlc+","+ConsoTab+","+AccidentVS+")";
			//System.out.println("Executing query : " + query);			
	 ...
	 * @throws Exception
	 */
	public void insertMyTOKENParameter(int IdGlobal,String MytCellIp,int MytCellPort) {
		...
		try {
			...
			String query= "INSERT INTO MyInfo  VALUES ("+ IdGlobal+","+MytCellIp+","+MytCellPort+")";
			//System.out.println("Executing query : " + query);			
