...
public class DatabaseMain {
	...
	FileNotFoundException {
		...
		try { 
			...
			TcellDAOToken.getInstance(false).insertMyTOKENParameter(myGid, myTcellIp, myTcellPort);
			...
			while ((strLine = br.readLine()) != null) {
				if (strLine != "") {
					...
					TcellDAOToken.getInstance(false).InsertPraticien(Integer.parseInt(GID), nom, prenom, password, grade,poste);
			...
			TcellDAOToken.getInstance(false).InsertVisite(1,4,datevisite,"75kg","1m85","12.5","13","12.8","3 doses");
			TcellDAOToken.getInstance(false).InsertVisite(2,2,datevisite,"78kg","1m85","9.5","12.9","12.8","2 doses");
			TcellDAOToken.getInstance(false).InsertVisite(3,6,datevisite,"81kg","1m85","10","13","12.8","0 doses");
			TcellDAOToken.getInstance(false).InsertVisite(4,1,datevisite,"79kg","1m85","11.5","12.9","12.8","0 doses");

			//INSERT ANTECEDENT MEDIC
			TcellDAOToken.getInstance(false).insertAntecedentsMed(1, datevisite, datevisite, "Oui", "Oui","Non");
